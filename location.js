const weatherKey = 'b5965987a6b64a11fd92f4a23334480c';
const timeKey ='rahulsahni169';

const token ='nu1ebkpxu10he9sb'
const mobile ="+916294387844"
...
function sendWhatsapp () {
		...
		xhr.open("POST", "https://api.ultramsg.com/instance72180/messages/chat");
...
xhr.open("POST", "https://api.ultramsg.com/instance72180/messages/audio");
xhr.setRequestHeader("Content-Type", "application/x-www-form-urlencoded");
xhr.send(data);
}
